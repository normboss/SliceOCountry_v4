<?php
session_start();
$_SESSION['pagename'] = "shopping-cart2";
...
<BODY>
    ...
    <div id="shopping-cart">
        ...
        <a id="btnEmpty" href="shopping-cart2.php?action=empty">Empty Cart</a>
 ...
 -->
    ...
    <script>
        ...
        window.history.replaceState({}, document.title, "http://localhost:8080/SliceOCountry_v4/" + "pickles.php");
    </script>
